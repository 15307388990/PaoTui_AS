...
public class RetrievePasswordActivity$$ViewBinder<T extends com.fmt.ming.paotui.activity.RetrievePasswordActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755284, "field 'etIphone'");
    target.etIphone = finder.castView(view, 2131755284, "field 'etIphone'");
    ...
    view = finder.findRequiredView(source, 2131755285, "field 'etNew2'");
    target.etNew2 = finder.castView(view, 2131755285, "field 'etNew2'");
