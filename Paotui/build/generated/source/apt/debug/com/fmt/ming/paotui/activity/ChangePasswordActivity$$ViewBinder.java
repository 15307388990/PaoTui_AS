...
public class ChangePasswordActivity$$ViewBinder<T extends com.fmt.ming.paotui.activity.ChangePasswordActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755203, "field 'etOld'");
    target.etOld = finder.castView(view, 2131755203, "field 'etOld'");
    view = finder.findRequiredView(source, 2131755204, "field 'cbOld'");
    target.cbOld = finder.castView(view, 2131755204, "field 'cbOld'");
    view = finder.findRequiredView(source, 2131755205, "field 'etOld2'");
    target.etOld2 = finder.castView(view, 2131755205, "field 'etOld2'");
    view = finder.findRequiredView(source, 2131755206, "field 'cbOld2'");
    target.cbOld2 = finder.castView(view, 2131755206, "field 'cbOld2'");
    view = finder.findRequiredView(source, 2131755207, "field 'etNew'");
    target.etNew = finder.castView(view, 2131755207, "field 'etNew'");
    view = finder.findRequiredView(source, 2131755208, "field 'cbNew'");
    target.cbNew = finder.castView(view, 2131755208, "field 'cbNew'");
