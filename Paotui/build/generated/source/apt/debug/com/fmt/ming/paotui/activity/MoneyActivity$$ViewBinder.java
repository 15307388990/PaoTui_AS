...
public class MoneyActivity$$ViewBinder<T extends com.fmt.ming.paotui.activity.MoneyActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755242, "field 'llListContent'");
    target.llListContent = finder.castView(view, 2131755242, "field 'llListContent'");
    ...
    view = finder.findRequiredView(source, 2131755240, "field 'll_freeze'");
    target.ll_freeze = finder.castView(view, 2131755240, "field 'll_freeze'");
  }
